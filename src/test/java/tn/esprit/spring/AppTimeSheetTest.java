...
public class AppTimeSheetTest {
	...
	public void getContratTest() throws ParseException { 
		...
		when(contratrepository.findAll()).thenReturn(Stream.of(new Contrat(debut,"Contrat de location",32F,yasser), new Contrat(debut,"Contrat de vente",440F,yasser)).collect(Collectors.toList()));
